...
struct iButton chips[] = {
  { 0x01, "DS1990A" },  // (DS1990R), DS2401, DS2411  1-Wire net address (registration number) only
  { 0x02, "DS1991" },   // Multikey iButton, 1152-bit secure memory
  { 0x03, "" },
  { 0x04, "DS1994" },   // DS2404  4Kb NV RAM memory and clock, timer, alarms
  { 0x05, "DS2405" },   // Single addressable switch
  { 0x06, "DS1993" },   // 4Kb NV RAM memory
  { 0x07, "" },
  { 0x08, "DS1992" },   // 1Kb NV RAM memory
  { 0x09, "DS1982" }    // DS2502  1Kb EPROM memory
